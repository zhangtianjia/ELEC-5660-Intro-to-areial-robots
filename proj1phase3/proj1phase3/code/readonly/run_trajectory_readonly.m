...
function run_trajectory_readonly(h1, h2, h3, h4, h5, h6, h7, h8, h9, Optimal_path, map)
...
pitch0 = -30*pi/180;
roll0  = -30*pi/180;
x0(1)  = Optimal_path(1,1); %x
x0(2)  = Optimal_path(1,2); %y
x0(3)  = Optimal_path(1,3); %z
x0(4)  = 0; %xdot
x0(5)  = 0; %ydot
x0(6)  = 0; %zdot
...
while (1)
    ...
    des_s = trajectory_generator(time, Optimal_path);
